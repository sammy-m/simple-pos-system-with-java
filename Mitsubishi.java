 ...
 * @author HP PAVILLION
 */
public class Mitsubishi extends VehicleProperties  implements Vehicle{
    @Override
    ...
    public void showAvailable() {
         try{
                     ...
                     Connection con = DbConnector.getConnection();
      Statement state = con.createStatement();
        ResultSet rs = state.executeQuery("SELECT * FROM vehicle WHERE brandId = '4' AND Status ='inStock' " );
      while(rs.next()){
